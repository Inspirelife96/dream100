...
extern NSString * const IAPPurchaseCancelNotification;
extern NSString * const IAPRestoreCancelNotification;
extern NSString * const IAPRestoreCompleteNotification;
extern NSString * const IAPPaymentRemovedNotification;
