...
- (void)viewDidLoad
{
    ...
    self.title = self.fromUser.username;
    ...
    self.demoData.fromUser = _fromUser;
    [MBProgressHUD showHUDAddedTo:self.view animated:YES];
    [self.demoData fetchTextData];
    [self.demoData initUserInfo];
...
//    }
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(getMoreMessage:) name:@"IFetchMoreMessageNotification" object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(noMoreMessage:) name:@"ILNoMoreMessageNotification" object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(getMessageError:) name:@"IFetchMessageErrorNotification" object:nil];
}
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    [[NSNotificationCenter defaultCenter] removeObserver:@"IFetchMoreMessageNotification"];
    [[NSNotificationCenter defaultCenter] removeObserver:@"ILNoMoreMessageNotification"];
    [[NSNotificationCenter defaultCenter] removeObserver:@"IFetchMessageErrorNotification"];
}

#pragma mark - notification
- (void)getMoreMessage:(id)notification {
    [MBProgressHUD hideHUDForView:self.view animated:YES];
    [self finishReceivingMessageAnimated:YES];
}

- (void)noMoreMessage:(id)notification {
    [MBProgressHUD hideHUDForView:self.view animated:YES];
    self.showLoadEarlierMessagesHeader = NO;
}

- (void)getMessageError:(id)notification {
    [MBProgressHUD hideHUDForView:self.view animated:YES];
}
                      ...
                      date:(NSDate *)date
{
    ...
    [messageObject setObject:self.fromUser forKey:@"toUser"];
    [messageObject setObject:text forKey:@"message"];
                ...
                header:(JSQMessagesLoadEarlierHeaderView *)headerView didTapLoadEarlierMessagesButton:(UIButton *)sender
{
    ...
    [MBProgressHUD showHUDAddedTo:self.view animated:YES];
    [self.demoData fetchMoreTextData];
}
...
- (void)collectionView:(JSQMessagesCollectionView *)collectionView didTapAvatarImageView:(UIImageView *)avatarImageView atIndexPath:(NSIndexPath *)indexPath
{
    ...
    ILUserDreamViewController *userDreamView = [storyboard instantiateViewControllerWithIdentifier:@"ILUserDreamViewController"];
    
    JSQMessage *message = self.demoData.messages[indexPath.row];
    if ([message.senderDisplayName isEqualToString:[AVUser currentUser].username]) {
        userDreamView.currentUser = nil;
    } else {
        userDreamView.currentUser = _fromUser;
    }
